...
var Pay = function Pay(_ref) {
  var okText = _ref.okText,
    ...
    return (0, _utils.$post)('/settleservice/trade/jxk-order-pay', reqModel);
  } : _ref$url,
  ...
  if (type === '2') {
    payDataSource.push({ label: '余额支付', value: 'S21' });
  }
  ...
  var totalBalance = function totalBalance() {
    var resVal = '' + (detail.balanceAccount + amountValue.paymentAmt);
    if (resVal !== 'NaN') {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'table',
        { className: _style2.default.my_table },
        _react2.default.createElement(
          'tbody',
          null,
      ...
      _react2.default.createElement(
        'div',
        { style: { color: '#aaa', fontSize: 12, marginTop: 15 } },
        '\u3010\u652F\u4ED8\u91D1\u989D\u5C0F\u4E8E2000\u4E0D\u80FD\u4F7F\u7528\u5BF9\u516C\u94F6\u8054\u652F\u4ED8\u3011'
      ),
      type === '1' ? _react2.default.createElement(
        'div',
