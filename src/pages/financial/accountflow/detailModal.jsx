...
class statementlist extends React.Component {
  ...
  show = (data) => {
    const { flowId } = data;
    Model.financial.flowInfo({ flowId }).then((res) => {
      if (res) {
        this.setState({
          info: res,
        });
        ...
        >
          <section className={styles.item_box}>
            <div className={styles.item}>
              ...
              <div className={styles.right}>{info.directRelationTypeDesc}</div>
            </div>
            <div className={styles.item}>
          ...
          <section className={styles.item_box}>
            ...
            <div className={styles.item}>
              <label className={styles.label}>交易时间</label>
              <div className={styles.right}>
